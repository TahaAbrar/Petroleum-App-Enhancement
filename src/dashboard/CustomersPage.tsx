...
export function CustomersPage({ searchQuery = '', onSearchChange }: Props) {
  ...
  return (
    <>
      <section className={`${panel} relative z-0 overflow-visible rounded-3xl p-4 lg:p-5`} aria-label="Search Account">
        <div className="mb-4 flex flex-col gap-3.5 lg:mb-5 lg:flex-row lg:items-start lg:justify-between">
          ...
          />
          <div className="relative z-20 grid grid-cols-2 gap-2 overflow-visible lg:flex lg:shrink-0 lg:flex-wrap lg:justify-end">
            <DateRangeFilter
              from={dateFrom}
              to={dateTo}
              onFromChange={(next) => {
